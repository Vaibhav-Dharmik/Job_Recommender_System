...
<div class="container-fluid">
   <%response.sendRedirect("http://localhost:80/JobRecommenderSystemPython/Clustering.py?userid="+session.getAttribute("userid").toString().trim()); %>
...
List<JobReg> lst=obj.getJobDetails2(session.getAttribute("userid").toString().trim());
if(lst.size()==0)
{
	%>
